...
size. Decoding requires one complete frame with an exact known content size. Truncated,
concatenated, trailing, corrupt, and size-mismatched data is rejected. Caller output changes only
after successful validation and decoding.

...
namespace simnet::render_detail
{
    ...
    entity_transform(Vec3f position, Vec3f heading, float scale) noexcept
    {
...
namespace simnet
{
    ...
    private:
        ...
        void select_adjacent_entity(
            RenderEntityView const& entities,
            int direction,
            ViewerResult& result
        );

        void update_panel_input(
        ...
        std::array<std::vector<Matrix>, render_detail::hue_bucket_count> transform_buckets_;
    };
} // namespace simnet

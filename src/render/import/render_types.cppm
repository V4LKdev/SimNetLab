...
export namespace simnet
{
    ...
    struct RenderReplicationInfo
    {
        ...
        std::optional<std::string_view> configured_delivery{};
        std::optional<std::string_view> effective_delivery{};
        std::optional<std::uint32_t> ack_lag_updates{};
        std::optional<std::uint64_t> ack_lag_ns{};
        std::optional<std::uint64_t> retained_snapshot_capacity_bytes{};
        std::optional<std::string_view> snapshot_recovery_reason{};
        std::optional<std::uint64_t> forced_full_replace_count{};
        std::optional<std::uint64_t> recovery_request_count{};
        std::optional<std::uint64_t> missing_baseline_rejection_count{};
        std::optional<std::uint64_t> baseline_eviction_count{};
        std::optional<std::uint64_t> sequence_gap_count{};
        std::optional<std::uint64_t> reliable_promotion_count{};
        std::optional<std::uint64_t> reliable_group_count{};
        std::optional<std::uint64_t> unreliable_group_count{};
        std::optional<std::uint64_t> reliable_packet_count{};
        std::optional<std::uint64_t> unreliable_packet_count{};
        std::optional<std::uint64_t> repeated_recovery_upserts{};
        std::optional<std::uint64_t> repeated_recovery_deletes{};
        ...
        std::optional<std::string_view> level_of_detail_mode{};
        std::optional<std::uint32_t> lod_near_population{};
        std::optional<std::uint32_t> lod_medium_population{};
        std::optional<std::uint32_t> lod_far_population{};
        std::optional<std::uint32_t> lod_near_eligible{};
        std::optional<std::uint32_t> lod_medium_eligible{};
        std::optional<std::uint32_t> lod_far_eligible{};
        std::optional<std::uint32_t> lod_near_serviced{};
        std::optional<std::uint32_t> lod_medium_serviced{};
        std::optional<std::uint32_t> lod_far_serviced{};
        std::optional<std::uint32_t> lod_near_represented{};
        std::optional<std::uint32_t> lod_medium_represented{};
        std::optional<std::uint32_t> lod_far_represented{};
        std::optional<std::uint32_t> lod_near_deferred{};
        std::optional<std::uint32_t> lod_medium_deferred{};
        std::optional<std::uint32_t> lod_far_deferred{};
        std::optional<std::uint32_t> lod_pending_due{};
        std::optional<std::uint32_t> lod_transitions{};
        std::optional<std::uint32_t> lod_forced_immediate{};
        std::optional<std::uint32_t> lod_recovery_forced{};
        std::optional<std::uint32_t> lod_deletions_bypassing{};
